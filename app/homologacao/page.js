...
export default function HomologacaoPage() {
  ...
  return (
    <main className={styles.page}>
      ...
      <footer className={styles.footer}><div className={styles.brand}><span className={styles.brandMark}>AC</span><span>A Castilho</span></div><p>Software • Produto • IA</p><p>© 2026 A Castilho</p></footer>
    </main>
  );
}
