(() => {
  ...
  function install() {
    ...
    if (!document.getElementById(STYLE_ID)) {
      ...
      style.id = STYLE_ID;
      style.textContent = `
        html[data-workspace-tone="black"]{--bg:#050505;--panel:#0b0b0c;--panel2:#121214;--line:#2b2c2f;--text:#f8fafc;--muted:#9ca3af;--green:#f8fafc;--green2:#cbd5e1}
        html[data-workspace-tone="graphite"]{--bg:#101214;--panel:#181b1f;--panel2:#22262b;--line:#353b43;--text:#f4f7fa;--muted:#a4adb8;--green:#d7dde5;--green2:#aab4c0}
        html[data-workspace-tone="rose"]{--bg:#1a0b12;--panel:#231018;--panel2:#311522;--line:#5a2338;--text:#fff3f7;--muted:#d4a9b7;--green:#ff4775;--green2:#ff6b91}
        html[data-workspace-tone="blue"]{--bg:#081225;--panel:#0d1a33;--panel2:#122545;--line:#294b7d;--text:#eef4ff;--muted:#9eb2d3;--green:#6284f5;--green2:#7a99ff}
        html[data-workspace-tone="mint"]{--bg:#071510;--panel:#0b2018;--panel2:#103126;--line:#245941;--text:#effff8;--muted:#9fc7b5;--green:#46d5a5;--green2:#69e4bc}
        html[data-workspace-tone="white"]{--bg:#f4f6f8;--panel:#ffffff;--panel2:#eef2f6;--line:#d7dde5;--text:#18212f;--muted:#667085;--green:#0d9f63;--green2:#078450}
        html[data-workspace-tone]{background:var(--bg,inherit)}
        html[data-workspace-tone] body{background-color:var(--bg,inherit);transition:background-color .2s ease,color .2s ease}
